...
internal class ZipStoredReader(private val source: BufferedSource) {
    ...
    private fun readLocalFileHeader(): LocalEntry {
        ...
        val compressedSize = (source.readIntLe().toLong() and 0xFFFFFFFFL).toInt()
        val uncompressedSize = (source.readIntLe().toLong() and 0xFFFFFFFFL).toInt()
        ...
        return LocalEntry(name = name, size = uncompressedSize, crc = crc)
    }
