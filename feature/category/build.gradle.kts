...
kotlin {
    android {
        namespace = "com.georgeci.moneysurfer.feature.category"
    }
...
// Pin the generated `Res` class package so callers can import `moneysurfer.feature.category.generated.resources.*`
// regardless of where compose-multiplatform's default would land it for nested gradle paths.
compose.resources {
    packageOfResClass = "moneysurfer.feature.category.generated.resources"
}

koinCompiler {
    // Per-module verification fails because category depends on data/domain/sync/shared bindings
...
// Full-screen Roborazzi captures of the category tree, editor and details screens.
