...
kotlin {
    android {
        namespace = "com.georgeci.moneysurfer.feature.transaction"
    }
...
compose.resources {
    packageOfResClass = "moneysurfer.feature.transaction.generated.resources"
}

koinCompiler {
    // Per-module verification fails because transaction depends on data/domain/sync/shared bindings
