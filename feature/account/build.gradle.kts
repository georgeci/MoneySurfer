...
kotlin {
    android {
        namespace = "com.georgeci.moneysurfer.feature.account"
    }
...
compose.resources {
    packageOfResClass = "com.georgeci.moneysurfer.feature.account.generated.resources"
}
...
// Full-screen Roborazzi captures of the account list, form and details screens.
