...
class GoalContributionSyncPlugin(
    ...
    override suspend fun push(mutation: PendingMutation) {
        ...
        when (mutation.operation) {
            ...
            -> {
                val entity = contributionDao.getById(mutation.entityId) ?: return
    ...
    private fun workspaceCollection(workspaceId: String) = firestore
        .collection("workspaces")
        .document(workspaceId)
        .collection(SyncCollection.GOAL_CONTRIBUTIONS)
}
