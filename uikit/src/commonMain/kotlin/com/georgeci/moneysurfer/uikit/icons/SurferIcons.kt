package com.georgeci.moneysurfer.uikit.icons
...
object SurferIcons {
    ...
    val CreditCard: ImageVector get() = Icons.Filled.CreditCard
    ...
    val Receipt: ImageVector get() = Icons.AutoMirrored.Filled.ReceiptLong
    val Logout: ImageVector get() = Icons.AutoMirrored.Filled.Logout
    val Archive: ImageVector get() = Icons.Filled.Archive
    val Restore: ImageVector get() = Icons.Filled.Restore
    val Category: ImageVector get() = Icons.Filled.Category
    val Tag: ImageVector get() = Icons.Filled.LocalOffer
    val Event: ImageVector get() = Icons.Filled.Event
    val Copy: ImageVector get() = Icons.Filled.ContentCopy
    val Split: ImageVector get() = Icons.AutoMirrored.Filled.CallSplit
    ...
    val Calendar: ImageVector get() = Icons.Filled.CalendarMonth
    ...
    // val Logo: DrawableResource get() = Res.drawable.ic_logo
}
